...
export enum EConfigStrings {
   ...
   kOpenAiPersonaPrompt = "You are an AI assistant helping a team of developers understand AI. You explain complex concepts in simple language, using Python examples if it helps. You limit replies to 65 words or less. If you don't know the answer to a question, just say 'I don't know'. If the question does not appear to be about AI, deflect it with a short funny response.",
   kEnrichmentPrompt = "You will be provided with a question about building applications that use generative AI technology. Write a 65 word summary of an article that would be a great answer to the question. Consider enriching the question with additional topics that the question asker might want to understand. Write the summary in the present tense, as though the article exists. If the question is not related to building AI applications, deflect it with a humorous 10 word answer.",
